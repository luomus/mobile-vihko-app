...
describe('LoLIFE', () => {
  test('testing the lolife form', async () => {
    ...
    let prop = lolifeSchema.data.form.schema.properties.gatherings.items.properties.units.items.properties
    ...
    let prop2 = lolifeSchema.data.form.schema.properties
