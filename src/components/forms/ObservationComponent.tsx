  ...
  const onUninitializedForm = () => {
    ...
    if (observationId) {
      ...
      if (observationState?.rules) {
        initForm(setForm, observationState, null, observationSchema, null, observationState.rules, fieldScopes, null, null, null, null, null, lang, scrollViewRef)
        //trip form edit observation
      } else if (schema.formID === forms.tripForm) {
        initForm(setForm, observationState, null, observationSchema, null, null, null, JX519Fields, overrideJX519Fields, additionalJX519Fields, JX519FieldOrder, uiSchemaContext, lang, scrollViewRef)
        ...
        initForm(setForm, observationState, null, observationSchema, null, null, null, MHL117Fields, overrideMHL117Fields, additionalMHL117, MHL117FieldOrder, null, lang, scrollViewRef)
      } else if (schema.formID === forms.fungiAtlas) {
        initForm(setForm, observationState, null, observationSchema, null, null, null, JX652Fields, overrideJX652Fields, null, null, null, lang, scrollViewRef)
      } else if (schema.formID === forms.dragonflyForm) {
        initForm(setForm, observationState, null, observationSchema, null, null, null, MHL932Fields, overrideMHL932Fields, null, null, null, lang, scrollViewRef)
      } else if (schema.formID === forms.butterflyForm) {
        initForm(setForm, observationState, null, observationSchema, null, null, null, MHL1040Fields, overrideMHL1040Fields, null, null, null, lang, scrollViewRef)
      } else if (schema.formID === forms.largeFlowersForm) {
        initForm(setForm, observationState, null, observationSchema, null, null, null, MHL1042Fields, overrideMHL1042Fields, null, null, null, lang, scrollViewRef)
      } else if (schema.formID === forms.mothForm) {
        initForm(setForm, observationState, null, observationSchema, null, null, null, MHL1043Fields, overrideMHL1043Fields, null, null, null, lang, scrollViewRef)
      } else if (schema.formID === forms.bumblebeeForm) {
        initForm(setForm, observationState, null, observationSchema, null, null, null, MHL1044Fields, overrideMHL1044Fields, null, null, null, lang, scrollViewRef)
      } else if (schema.formID === forms.herpForm) {
        initForm(setForm, observationState, null, observationSchema, null, null, null, MHL1045Fields, overrideMHL1045Fields, null, null, null, lang, scrollViewRef)
      ...
      if (props.rules) {
        initForm(setForm, defaultObject, null, observationSchema, null, props.rules, fieldScopes, null, null, null, null, null, lang, scrollViewRef)
        //trip form new observation
      } else if (schema.formID === forms.tripForm) {
        initForm(setForm, defaultObject, null, observationSchema, null, null, null, JX519Fields, overrideJX519Fields, additionalJX519Fields, JX519FieldOrder, uiSchemaContext, lang, scrollViewRef)
      } else if (schema.formID === forms.birdAtlas) {
        const additionalMHL117 = observationState?.id.includes('complete_list') ? null : additionalMHL117Fields
        initForm(setForm, defaultObject, null, observationSchema, null, null, null, MHL117Fields, overrideMHL117Fields, additionalMHL117, MHL117FieldOrder, null, lang, scrollViewRef)
      } else if (schema.formID === forms.fungiAtlas) {
        initForm(setForm, defaultObject, null, observationSchema, null, null, null, JX652Fields, overrideJX652Fields, null, null, null, lang, scrollViewRef)
      } else if (schema.formID === forms.dragonflyForm) {
        initForm(setForm, defaultObject, null, observationSchema, null, null, null, MHL932Fields, overrideMHL932Fields, null, null, null, lang, scrollViewRef)
      } else if (schema.formID === forms.butterflyForm) {
        initForm(setForm, defaultObject, null, observationSchema, null, null, null, MHL1040Fields, overrideMHL1040Fields, null, null, null, lang, scrollViewRef)
      } else if (schema.formID === forms.largeFlowersForm) {
        initForm(setForm, defaultObject, null, observationSchema, null, null, null, MHL1042Fields, overrideMHL1042Fields, null, null, null, lang, scrollViewRef)
      } else if (schema.formID === forms.mothForm) {
        initForm(setForm, defaultObject, null, observationSchema, null, null, null, MHL1043Fields, overrideMHL1043Fields, null, null, null, lang, scrollViewRef)
      } else if (schema.formID === forms.bumblebeeForm) {
        initForm(setForm, defaultObject, null, observationSchema, null, null, null, MHL1044Fields, overrideMHL1044Fields, null, null, null, lang, scrollViewRef)
      } else if (schema.formID === forms.herpForm) {
        initForm(setForm, defaultObject, null, observationSchema, null, null, null, MHL1045Fields, overrideMHL1045Fields, null, null, null, lang, scrollViewRef)
      } else if (schema.formID === forms.subarcticForm) {
